...
namespace MJProceduralMass
{
    public class Function
    {
        ...
        private IModelStore<MJProceduralMassInputs> store;

        public async Task<MJProceduralMassOutputs> Handler(MJProceduralMassInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<MJProceduralMassInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<MJProceduralMassInputs,MJProceduralMassOutputs>(store, MJProceduralMass.Execute);
